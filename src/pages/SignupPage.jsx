...
export default function SignupPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      ...
      >
        <h1 className="font-display text-3xl font-bold">Join SkillSync</h1>
        <p className="mt-2 text-white/55">Create a free learner account.</p>
        ...
        <p className="mt-4 text-center text-sm text-white/50">
          Already learning? <Link className="text-tideBright" to="/login">Sign in</Link>
        </p>
      </motion.form>
    </div>
  )
